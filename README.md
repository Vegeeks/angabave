...
Versión **alfa v0.4.1**. El historial está en [CHANGELOG.md](CHANGELOG.md).
...
* **Escenarios** ordena a los que todavía pueden ganar la semana por el
  porcentaje de combinaciones en que terminan primeros.
...
partido. Si el cron llega tarde, la tarde queda cubierta igual. Para arrancarlo
a mano:
